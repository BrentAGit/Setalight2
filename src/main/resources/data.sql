...
insert into event(ID,AANTALDEELNEMERS,POSTCODE,CITY,STREET,HOUSENUMBER,CONTROLE,DATUM,DESCRIPTION,END_TIME,NAME,START_TIME)
    VALUES(nextval('EVENT_SEQ'),50,'2800','Mechelen', 'Zandpoortvest', '60',true,'2020-05-17','Test description','15:00','testevent','19:00');
insert into event(ID,AANTALDEELNEMERS,POSTCODE,CITY,STREET,HOUSENUMBER,CONTROLE,DATUM,DESCRIPTION,END_TIME,NAME,START_TIME)
    VALUES(nextval('EVENT_SEQ'),50,'2800','Mechelen', 'Zandpoortvest', '60',true,'2020-04-17','Test description','15:00','testevent','19:00');
insert into event(ID,AANTALDEELNEMERS,POSTCODE,CITY,STREET,HOUSENUMBER,CONTROLE,DATUM,DESCRIPTION,END_TIME,NAME,START_TIME)
    VALUES(nextval('EVENT_SEQ'),50,'2800','Mechelen', 'Zandpoortvest', '60',true,'2020-06-17','Test description','15:00','testevent','19:00');
